      ...
      <div className="hidden py-20 text-center bg-blue-100 dark:bg-gray-700 lg:block">
        <div className="max-w-6xl mx-auto mb-24">
          ...
          <p className="mb-6 text-xl text-gray-500 ">
            Lorem ipsum dor amet set imoris ipdum styeirdksa
          </p>
        </div>
      </div>
              ...
              <div className="flex justify-center">
                <Link to="" className="">
                  <svg
                    ...
                    height="30"
                    fill="currentColor"
                    className="mr-6 text-blue-700 dark:text-blue-400 bi bi-facebook"
                    viewBox="0 0 16 16"
                  >
                ...
                <Link to="" className="">
                  <svg
                    ...
                    height="30"
                    fill="currentColor"
                    className="mr-6 text-green-600 dark:text-green-400 bi bi-whatsapp"
                    viewBox="0 0 16 16"
                  >
                ...
                <Link to="" className="">
                  <svg
                    ...
                    height="30"
                    fill="currentColor"
                    className="mr-6 text-blue-500 dark:text-blue-400 bi bi-twitter"
                    viewBox="0 0 16 16"
                  >
                ...
                <Link to="" className="">
                  <svg
                    ...
                    height="30"
                    fill="currentColor"
                    className="text-red-600 dark:text-red-400 bi bi-linkedin "
                    viewBox="0 0 16 16"
                  >
