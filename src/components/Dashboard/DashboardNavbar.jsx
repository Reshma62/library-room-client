      ...
      <div className="bg-gray-100 xl:h-screen sdfbg-gray-800">
        <div className="body-content">
          <div className="relative lg:block navbar-menu">
            <nav
              className={`fixed top-0 transition-all lg:mt-0 z-40 mt-16 ${
                openSidebar ? " left-0" : "-left-96"
              }  sdfbg-gray-900 bottom-0 flex flex-col w-[280px] lg:border-none border-r border-gray-200 sdfborder-gray-800 bg-gray-50 overflow-hidden`}
              id="sidenav"
            >
              <div className="flex items-center w-full px-4 pt-4 pb-4 border-b border-gray-200 sdfborder-gray-700">
                <a href="#">
                  <div className="flex items-center ml-2">
                    <Link to={"/"}>
                      <h2 className="ml-3 text-lg font-bold rounded-md sdftext-gray-400 whitespace-nowrap bg-primaryColor py-2.5 flex gap-2 items-center  px-5 text-white">
                        <AiOutlineArrowLeft className="font-medium" /> Go to
                        Main Layout
                      </h2>
                    </Link>
                  </div>
                  ...
                  {dahshoardMenu.map((menu) => (
                    ...
                    >
                      <NavLink
                        ...
                        className={() =>
                          `  sdftext-gray-300 text-lg leading-8 inline-block py-2.5 px-4 hover:text-blue-200 sdfhover:text-blue-300 rounded-md capitalize font-medium `
                        }
                      >
                        <span className="inline-block mr-3">{menu.icon}</span>
          ...
          >
            <section className="sticky top-0 z-40 px-3 py-3 bg-white shadow sdftext-gray-100 sdfbg-gray-900 lg:px-5">
              <nav className="relative">
                <div className="flex items-center justify-between">
                  <div onClick={() => setOpenSidebar(!openSidebar)}>
                    <button className="px-2 py-3 text-blue-500 bg-blue-100 rounded sdftext-gray-400 sdfbg-gray-800">
                      <svg
                        width="18"
                        height="10"
                        viewBox="0 0 18 10"
                    ...
                    <div className="justify-center hidden mr-4 md:flex">
                      <div className=" xl:w-96">
                        <div className="relative flex flex-wrap items-center w-full ">
                          <input
                            type="search"
                            className="form-control relative flex-auto min-w-0 block w-72 px-3 py-1.5 text-base font-normal text-gray-700 bg-white  sdftext-gray-100  border border-solid border-gray-300 sdfborder-gray-800 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white sdfbg-gray-800  focus:border-b sdfborder-gray-700lue-600 focus:outline-none"
                            placeholder="Search"
                          />
                          <button
                            className="btn i px-6 py-2.5 bg-blue-600 sdfbg-blue-300 sdfhover:bg-blue-400  sdftext-gray-900 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700  focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out flex items-center"
                            type="button"
                            id="button-addon2"
                          >
                            <svg
                    ...
                    <div className="relative text-left lg:inline-block">
                      ...
                      >
                        <div className="py-1">
                          <a
                            href="#"
                            className="flex px-4 py-2 text-sm text-gray-700 sdftext-gray-400 sdfhover:bg-gray-800 hover:bg-gray-100"
                          >
                            <svg
                              className="mr-2"
                              xmlns="http://www.w3.org/2000/svg"
